...
import 'package:wedded_flutter/layout/nwpred.dart';
import 'package:wedded_flutter/layout/predict.dart';
import 'package:wedded_flutter/layout/review.dart';
import 'package:wedded_flutter/layout/view_vendor.dart';
import 'package:wedded_flutter/layout/view_vendor_1.dart';
// import 'package:http/http.dart';
// import 'package:medicine_box2/layout/login.dart';
class predict_list extends StatefulWidget {
  const predict_list({Key? key}) : super(key: key);

  @override
  State<predict_list> createState() => _predict_listState();
}

class _predict_listState extends State<predict_list> {
  // late List data;
                    ...
                    onTap: () {
                      if(index==0)
                      {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (BuildContext context) => const nwpred()));
                      }
                      else if(index==1)
                      {
                        // Navigator.of(context).push(MaterialPageRoute(
                      ...
                      else if(index==3)
                      {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (BuildContext context) => const predict()));
                      }
                      // print("tapped");
                      //  tap funtion here
                    },
